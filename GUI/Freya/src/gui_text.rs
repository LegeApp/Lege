    ...
    GuiText {
        interactive: GuiInteractiveText {
            ...
            tooltips: GuiTooltipsText {
                ...
                layout_detection: "GPU accelerated layout detection preserves image areas from binarization; disable if no images in document.".to_string(),
                ...
                jpeg_compatibility: "use JPEG instead of JPEG2000 for images".to_string(),
                ...
                cover_format_dithered: "CCITT4 text with dithered image regions where enabled (global)".to_string(),
