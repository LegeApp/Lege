...
use super::{ColorMode, DocumentId, PageIndex};
...
pub struct TileKey {
    ...
    pub coord: TileCoord,
    pub tier: TileTier,
    /// Changes whenever crop or palette changes, so stale in-flight work can
    /// coexist without masquerading as the current rendering.
    pub variant: u64,
}
