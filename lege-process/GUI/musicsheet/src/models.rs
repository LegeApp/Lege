...
/// Default output page height for music viewed on desktop displays.
pub const DEFAULT_MUSIC_TARGET_HEIGHT: u32 = 1600;
...
impl ProcessingOptions {
    pub fn new() -> Self {
        Self {
            ...
            original_cover: true,
            target_height: Some(DEFAULT_MUSIC_TARGET_HEIGHT),
...
mod tests {
    ...
    #[test]
    fn music_sheet_default_uses_desktop_resolution() {
        let options = ProcessingOptions::new();
        assert_eq!(options.target_height, Some(DEFAULT_MUSIC_TARGET_HEIGHT));
